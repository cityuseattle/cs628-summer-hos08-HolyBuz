...
passport.use(
  new FacebookStrategy(
    {
      clientID: '189078464187132',
      clientSecret: '4cf457350364367afff6741527d98f40',
      // Your callback URL
      callbackURL: 'https://humble-potato-q9794q4g549h6xrx-5050.app.github.dev/facebook/callback', 
...
app.get('/facebook/callback', passport.authenticate('facebook', {
  ...
  successRedirect: 'https://effective-broccoli-54g4rqrpw9p24xg9-3000.app.github.dev/home', 
  // Redirect to login page on authentication failure.
  failureRedirect: 'https://effective-broccoli-54g4rqrpw9p24xg9-3000.app.github.dev/', 
}));
